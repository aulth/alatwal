            ...
            <div className="flex flex-wrap mt-3">
                <div className="w-full md:w-1/3 px-4 mb-8">
                    <div className="bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden">
                        ...
                        <div className="px-6 py-4">
                            <div className="font-bold text-xl mb-2 cursor-pointer hover:text-gray-700">Desert Safari</div>
                ...
                <div className="w-full md:w-1/3 px-4 mb-8">
                    <div className="bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden">
                        ...
                        <div className="px-6 py-4">
                            <div className="font-bold text-xl mb-2 cursor-pointer hover:text-gray-700">Burj Khalifa</div>
                            <p className="text-gray-700 text-base">
                ...
                <div className="w-full md:w-1/3 px-4 mb-8">
                    <div className="bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden">
                        ...
                        <div className="px-6 py-4">
                            <div className="font-bold text-xl mb-2 cursor-pointer hover:text-gray-700">Dhow Cruise</div>
                            <p className="text-gray-700 text-base">
                ...
                <div className="w-full md:w-1/3 px-4 mb-8">
                    <div className="bg-white rounded-lg shadow-lg hover:shadow-xl overflow-hidden">
                        ...
                        <div className="px-6 py-4">
                            <div className="font-bold text-xl mb-2 cursor-pointer hover:text-gray-700">Wild Wadi Water Park</div>
                            <p className="text-gray-700 text-base">
