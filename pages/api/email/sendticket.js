...
const sendTicket = async (req, res) => {
    const { email, ticket, bookingDetails, bookingNumber, name } = JSON.parse(JSON.stringify(req.body));
    ...
    const mailOption = {
        ...
        to: email,
        subject: "Ticket "+bookingDetails.title,
    ...
    transporter.sendMail(mailOption, (err, info) => {
        ...
        return res.json({ success: true, info, msg:'Ticket sent to the client' });
    });
}
