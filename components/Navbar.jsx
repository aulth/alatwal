            ...
            <div className='sticky top-0 z-50'>
                ...
                <Link  className="text-3xl font-bold leading-none" href={"/"}>
                    ...
                    }
                    {
                        !settingData && 
                        <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:items-center lg:w-auto lg:space-x-6">
                        <li className="text-sm text-blue-400 hover:text-orange-500 hover:font-semibold bg-gray-50 h-6 w-16 flex animate-pulse rounded"></li>
                        <li className="text-sm text-blue-400 hover:text-orange-500 hover:font-semibold bg-gray-50 h-6 w-16 flex animate-pulse rounded"></li>
                        <li className="text-sm text-blue-400 hover:text-orange-500 hover:font-semibold bg-gray-50 h-6 w-16 flex animate-pulse rounded"></li>
                        <li className="text-sm text-blue-400 hover:text-orange-500 hover:font-semibold bg-gray-50 h-6 w-16 flex animate-pulse rounded"></li>
                        <li className="text-sm text-blue-400 hover:text-orange-500 hover:font-semibold bg-gray-50 h-6 w-16 flex animate-pulse rounded"></li>
                        ...
                        <div>
                            {
                                ...
                                <li className="mb-1">
                                    <a className="block p-4 text-sm font-semibold text-blue-400 hover:bg-blue-50 hover:text-blue-600 rounded" href={settingData.menu5Link}>{settingData.menu5Title}</a>
                                </li>
                            </ul>
                            }
                            {
