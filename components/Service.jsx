  ...
  return (
    <div  style={{ minHeight: 'calc(100vh - 72px)' }}  className="flex flex-col justify-center items-center p-2">
        ...
        <div className="w-full flex md:flex-row flex-col justify-around items-center my-3">
          <div className='md:w-[200px] m-2 mt-4 flex flex-col items-center rounded font-[helvetica] border border-transparent hover:border hover:border-blue-400 hover:shadow-lg md:p-2 py-8 text-white'>
