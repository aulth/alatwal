...
const AddNewTour = () => {
    ...
    const handleOnAdd = async (e) => {
        ...
        if (typeof window !== 'undefined') {
            if (!tourData.title || !image.length>0 || !tourData.featuredTour || !tourData.availability || !tourData.bookingPolicy || !tourData.category || !tourData.childRatePrime ||  !tourData.adultRatePrime || !tourData.infantRatePrime || !tourData.childRateNonPrime || !tourData.adultRateNonPrime || !tourData.infantRateNonPrime   || !tourData.description || !tourData.duration || !tourData.googleMapLocation || !tourData.highlights || !tourData.importantInformation) {
                ...
                <form onSubmit={handleOnAdd} className='w-full p-4 ' action="">
                    ...
                    <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
                        ...
                        <div className="w-full flex items-center justify-center">
                            <input type="number" name="adultRatePrime" onChange={handleOnTextChange} placeholder="250" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                            <input type="number" name="adultRateNonPrime" onChange={handleOnTextChange} placeholder="200" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                        </div>
                    </div>
                    <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
                        ...
                        <div className="w-full flex items-center justify-center">
                            <input type="number" name="childRatePrime" onChange={handleOnTextChange} placeholder="120" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                            <input type="number" name="childRateNonPrime" onChange={handleOnTextChange} placeholder="100" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                        </div>
                    </div>
                    <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
                        ...
                        <div className="w-full flex items-center justify-center">
                            <input type="number" name="infantRatePrime" onChange={handleOnTextChange} placeholder="60" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                            <input type="number" name="infantRateNonPrime" onChange={handleOnTextChange} placeholder="50" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                        </div>
                    </div>
                    <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
