...
const AddNewTour = () => {
    ...
    const handleOnAdd = async (e) => {
        ...
        if (typeof window !== 'undefined') {
            if (!tourData.title || !image.length>0 || !tourData.featuredTour || !tourData.availability || !tourData.bookingPolicy || !tourData.category || !tourData.adultRateTicketOnly ||  !tourData.adultRateSharingTransport || !tourData.adultRatePrivateTransport || !tourData.childRateTicketOnly || !tourData.childRateSharingTransport || !tourData.childRatePrivateTransport || !tourData.infantRateTicketOnly || !tourData.infantRateSharingTransport || !tourData.infantRatePrivateTransport || !tourData.description || !tourData.duration || !tourData.googleMapLocation || !tourData.highlights || !tourData.importantInformation) {
            ...
            <ToastContainer />
                    {
                        ...
                        <form onSubmit={handleOnAdd} className='w-full p-4 ' action="">
                            ...
                            <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
                                ...
                                <input type="text" name="pickup" onChange={handleOnTextChange} placeholder="Separated by comma ," className='w-full focus:outline focus:outline-blue-400 p-1 rounded border' />
                            </div>
                            ...
                            <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
                                ...
                                <div className="w-full flex items-center justify-center">
                                    <input type="number" name="adultRateTicketOnly" onChange={handleOnTextChange} placeholder="200" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                                    <input type="number" name="adultRateSharingTransport" onChange={handleOnTextChange} placeholder="210" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                                    <input type="number" name="adultRatePrivateTransport" onChange={handleOnTextChange} placeholder="220" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                                </div>
                            </div>
                            <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
                                ...
                                <div className="w-full flex items-center justify-center">
                                    <input type="number" name="childRateTicketOnly" onChange={handleOnTextChange} placeholder="200" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                                    <input type="number" name="childRateSharingTransport" onChange={handleOnTextChange} placeholder="210" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                                    <input type="number" name="childRatePrivateTransport" onChange={handleOnTextChange} placeholder="220" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
                                </div>
                            </div>
                            <div className="w-full flex flex-col md:flex-row md:justify-between mb-6">
                                ...
                                <div className="w-full flex items-center justify-center">
                                    <input type="number" name="infantRateTicketOnly" onChange={handleOnTextChange} placeholder="200" className='w-full focus:outline focus:outline-blue-400 p-1 rounded border mx-1' />
